...
class StableDiffusionControlnetAITPipeline(DiffusionPipeline):
    ...
    def unet_inference(self, latent_model_input, timesteps, encoder_hidden_states,
                       dbar_0, dbar_1, dbar_2, dbar_3,
                       dbar_4, dbar_5, dbar_6, dbar_7,
                       dbar_8, dbar_9, dbar_10, dbar_11,
        ...
        inputs = {
            ...
            "input15": mid_block_additional_residual.permute((0, 2, 3, 1)).contiguous().cuda().half(),
